...
//	
	...
	public UserDetailsService userDetailsService() {
		return new UserDetailsService() {
			...
			public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
				...
				return loginRepo.findByEmail(username).orElseThrow(() -> new UsernameNotFoundException("User not found"));
			}
	...
	public JwtAuthenticationDTO signinDTO(LoginPerson loginPerson) {
		...
		authenticationManager.authenticate(new UsernamePasswordAuthenticationToken(loginPerson.getEmail(), loginPerson.getPassword()));
		
		var user= loginRepo.findByEmail(loginPerson.getEmail()).orElseThrow(() -> new IllegalArgumentException("Invalid email or password"));
