...
//	        configuration.setAllowedOrigins(Arrays.asList("http://localhost:3000")); // Adres Twojej aplikacji frontendowej
	    ...
	    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
	        http
	            ...
	            .authorizeHttpRequests(auth -> auth
	                ...
	                .requestMatchers("/newPerson", "/images", "/person", "/loginPerson", "/deletePerson", "/newPerson", "/editPerson", "/signin","/refresh","/loginPerson", "/addOrder", "/personDetails", "/newEvent", "/orders","/reservations","/reservations/person", "/history", "/reviews/person", "/newReservation", "/newComment","/orders/person","/updateEvent", "/deleteEvent", "/customNumberOfPeople", "/cancleReservation","/coffee", "/uploadImage", "/addImage/{idProduct}", "/products", "/updateRoleType", "/order-status", "/update-order-status", "/addProduct", "/updateProducts", "/deleteCoffee","/employees", "/editUser", "/deleteComment").permitAll()
